...
function Users(){
    ...
    const getdata = async()=>{
        ...
        let users = [...(returnedData.Customers)];
        setSanai3i([...users]);
    }
    return(
        <div className='cont'>
            ...
            <div className='users'>
                ...
                {(sanai3i!==undefined)?((sanai3i.length!==0)?<table dir="rtl" width={"100%"}>
                                            ...
                                            <td width={"(100/7)%"}>
                                                <div className="d-flex justify-content-around align-items-center">
                                                    <button className='b-green' onClick={async(e)=>{
                                                        let call_api = new Admin();
                                                        let link_api = (el.status==="active")?"http://127.0.0.1:8000/api/sanai3i/admin/allusers/suspendcustomer":"http://127.0.0.1:8000/api/sanai3i/admin/allusers/activate";
                                                    ...
                                                    <button className='b-red' onClick={async(e)=>{
                                                        let call_api = new Admin();
                                                        let link_api = "http://127.0.0.1:8000/api/sanai3i/admin/allusers/deletecustomer";
                                                        let admin_token = sessionStorage.getItem('adminToken');
                    ...
                    </table>:<div className="text-center">لا يوجد مظفين</div>):<div className='d-flex justify-content-center align-items-center p-2'><div className='empty'></div></div>
                }
                </div>
            </div>
        </div>
