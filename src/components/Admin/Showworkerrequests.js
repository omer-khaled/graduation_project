...
function Showworkerrequests(){
    ...
    const getdata = async()=>{
        ...
        let link_api = "http://127.0.0.1:8000/api/sanai3i/admin/allusers/requestedworkers";
        ...
        <div className='cont'>
            ...
            <div className='users'>
                ...
                <div className="table-responsive">
                    ...
                    </table>:<div className="text-center">لا يوجد طلبات عمال</div>):<div className='d-flex justify-content-center align-items-center p-2'><div className='empty'></div></div>}
                </div>
            </div>
        </div>
    );
}
export default Showworkerrequests;